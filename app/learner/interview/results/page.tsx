...
function InterviewResultsContent() {
      ...
      try {
        ...
        if (storedResults) {
          try {
            ...
            const formattedData = {
              ...
              results: {
                ...
                communicationFeedback:
                  parsedResults.detailedFeedback.communication,
                problemSolvingFeedback:
                  parsedResults.detailedFeedback.problemSolving,
            ...
            console.warn(
              "Failed to parse stored results, falling back to API:",
              parseError
            );
          }
        }
  ...
  const showCodeMetrics = interviewData.configuration?.hasCodeEditor === true;
  const results = {
      ...
      <div className="md:ml-64 ml-0 pt-16 md:pt-20 pb-24 md:pb-12">
        <div className="container-custom space-y-8">
          ...
          <div className="glass-card text-center p-8 neon-glow">
              ...
              <div className="flex items-center justify-center mt-2">
                {[...Array(5)].map((_, i) => (
                  <Star
                    ...
                    size={20}
                    className={`${
                      i < Math.floor(results.overallScore / 20)
            ...
            <div
              className={`grid ${
                showCodeMetrics ? "md:grid-cols-4" : "md:grid-cols-3"
              } gap-6`}
            >
              <div>
                <div
