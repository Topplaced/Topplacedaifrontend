    ...
    development: [
      ...
      },
      {
        ...
        languages: [
          ...
          { id: "ruby", name: "Ruby", description: "Ruby programming language" },
          ...
          { id: "scala", name: "Scala", description: "Scala programming language" },
      ...
      },
      {
        ...
        languages: [
          ...
          { id: "ruby", name: "Ruby/Rails", description: "Ruby on Rails stack" },
          { id: "go", name: "Go/Gin", description: "Go full-stack development" },
          { id: "typescript", name: "TypeScript/Node.js", description: "TypeScript full-stack" },
          { id: "rust", name: "Rust/Actix", description: "Rust full-stack development" },
        ],
      },
      {
        ...
        languages: [
          ...
          { id: "dart", name: "Dart", description: "Dart language for Flutter" },
          { id: "objective-c", name: "Objective-C", description: "iOS development (legacy)" },
          { id: "xamarin", name: "Xamarin", description: "Microsoft mobile development" },
          { id: "ionic", name: "Ionic", description: "Hybrid mobile development" },
          { id: "cordova", name: "Apache Cordova", description: "PhoneGap mobile development" },
        ],
      },
      {
