  ...
  const handleCreditPackPurchase = (pack: any) => {
    const planData = {
      ...
      features: [
        ...
        `${pack.duration}-minute interviews`,
        `Save ₹${pack.savings}`,
      ],
      orderType: "credits",
        ...
        <div className="container-custom">
          ...
          <div className="mb-20">
                ...
                return (
                  <div
                    ...
                    className={`glass-card p-8 relative transition-all duration-300 hover:scale-105 ${
                      interview.popular
                        ? "border-2 border-[#00FFB2] neon-glow"
                        : ""
                    }`}
                  >
                    {interview.popular && (
                    ...
                    <div className="space-y-4 mb-8">
                      {interview.features.map((feature, featureIndex) => (
                        <div key={featureIndex} className="flex items-center">
                          <Check
                            size={16}
                            className="text-[#00FFB2] mr-3 flex-shrink-0"
                          />
                    ...
                    <button
                      ...
                      className={`w-full py-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center ${
                        interview.popular ? "btn-primary" : "btn-outline"
                      }`}
                    >
                      Buy Interview
            ...
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold mb-4">
                Credit Packs -{" "}
                <span className="gradient-text">Better Value</span>
              </h3>
                ...
                >
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-400 mb-4">
                      ₹{Math.round(pack.price / pack.credits)} per{" "}
                      {pack.duration}-min interview
                    </p>
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="glass-card p-6 text-left">
                ...
                <p className="text-gray-400">
                  Our Starter plan is completely free forever. You can also try
                  Professional features with a 7-day free trial.
                </p>
              </div>

              <div className="glass-card p-6 text-left">
                <h3 className="text-lg font-semibold mb-3">
                  How does AI interview matching work?
                </h3>
                <p className="text-gray-400">
                  Our system studies your profile and adapts interview questions
                  and feedback to match your career objectives and improvement
                  areas.
                </p>
              </div>
          ...
          <div className="glass-card p-12 text-center neon-glow">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of professionals who are already growing with Top
              placed
            </p>
